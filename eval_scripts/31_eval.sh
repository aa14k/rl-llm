...
date='8-13-'
run=''
name='Qwen2.5-0.5B-Instruct-gsm8k-gamma0.9999999-seed43-1epoch-31'
...
name='Qwen2.5-0.5B-Instruct-gsm8k-gamma0.99999995-seed43-1epoch-31'
CUDA_VISIBLE_DEVICES=1 python eval.py \
  --model_name "${path}${name}/checkpoint-935" \
  --runs 30 --max_model_len 1024 --temperature 0.0 --top_p 1.0 --top_k 0 --max_tokens 786 \
  > "eval_results/${date}${name}${run}.txt" &

name='Qwen2.5-0.5B-Instruct-gsm8k-gamma0.99999999-seed43-1epoch-31'
CUDA_VISIBLE_DEVICES=2 python eval.py \
  --model_name "${path}${name}/checkpoint-935" \
  --runs 30 --max_model_len 1024 --temperature 0.0 --top_p 1.0 --top_k 0 --max_tokens 786 \
  > "eval_results/${date}${name}${run}.txt" &

name='Qwen2.5-0.5B-Instruct-gsm8k-gamma1.0-seed42-1epoch-31'
CUDA_VISIBLE_DEVICES=3 python eval.py \
  --model_name "${path}${name}/checkpoint-935" \
  --runs 30 --max_model_len 1024 --temperature 0.0 --top_p 1.0 --top_k 0 --max_tokens 786 \
  > "eval_results/${date}${name}${run}.txt" &

name='Qwen2.5-0.5B-Instruct-gsm8k-gamma0.9999995-seed42-1epoch-182'
...
name='Qwen2.5-0.5B-Instruct-gsm8k-gamma1.0-seed41-beta0.001-16steps-1epoch-193'
