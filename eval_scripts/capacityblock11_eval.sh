...
name='phi-4-math-gamma0.999-seed42-beta0.01-big-capacityblock11'
...
CUDA_VISIBLE_DEVICES=2 python huggingface_eval_olympiad.py \
  --model_name "${path}${name}/checkpoint-1166" \
  --runs 5 --max_model_len 4608 --temperature 0.0 --top_p 1.0 --max_tokens 3072 --seed 42 \
  > "eval_results/${date}${name}${run}-42-olympiad-1.txt" &

# CUDA_VISIBLE_DEVICES=1 python huggingface_eval_aime2024.py \
#   --model_name "${path}${name}/checkpoint-1166" \
#   --runs 5 --max_model_len 4608 --temperature 0.0 --top_p 1.0 --max_tokens 3072 --seed 42 \
#   > "eval_results/${date}${name}${run}-42-aime24.txt" &

CUDA_VISIBLE_DEVICES=3 python huggingface_eval_minerva.py \
  --model_name "${path}${name}/checkpoint-1166" \
  --runs 5 --max_model_len 4608 --temperature 0.0 --top_p 1.0 --max_tokens 3072 --seed 42 \
...
CUDA_VISIBLE_DEVICES=6 python huggingface_eval_olympiad.py \
  --model_name "${path}${name}/checkpoint-1166" \
  --runs 5 --max_model_len 4608 --temperature 0.0 --top_p 1.0 --max_tokens 3072 --seed 42 \
  > "eval_results/${date}${name}${run}-42-olympiad-1.txt" &

# CUDA_VISIBLE_DEVICES=5 python huggingface_eval_aime2024.py \
#   --model_name "${path}${name}/checkpoint-1166" \
#   --runs 5 --max_model_len 4608 --temperature 0.0 --top_p 1.0 --max_tokens 3072 --seed 42 \
#   > "eval_results/${date}${name}${run}-42-aime24.txt" &

CUDA_VISIBLE_DEVICES=7 python huggingface_eval_minerva.py \
  --model_name "${path}${name}/checkpoint-1166" \
  --runs 5 --max_model_len 4608 --temperature 0.0 --top_p 1.0 --max_tokens 3072 --seed 42 \
  > "eval_results/${date}${name}${run}-42-minerva.txt" &
